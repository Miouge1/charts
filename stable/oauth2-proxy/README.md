...
This version upgrade oauth2-proxy to v4.0.0. Please see the [changelog](https://github.com/oauth2-proxy/oauth2-proxy/blob/master/CHANGELOG.md#v400) in order to upgrade.
